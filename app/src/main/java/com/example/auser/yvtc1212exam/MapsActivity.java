...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        taipei = new LatLng[MainActivity.idArray.size()];

        for(int i = 0; i <=MainActivity.idArray.size()-1; i++){
            taipei[i] = new LatLng(MainActivity.latitudeArray.get(i), MainActivity.longitudeArray.get(i));
            mMap.addMarker(new MarkerOptions().position(taipei[i]).title(MainActivity.stitleArray.get(i)));
        }
